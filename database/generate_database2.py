...
import fitz  # PyMuPDF
import numpy as np
from logics.util import get_embedding  # get_embedding 함수가 필요합니다.
...
print(chunk_embedding_list)



with open('./database/database2.py', 'w', encoding='UTF-8') as file:
    file.write(f"data = {chunk_embedding_list}")